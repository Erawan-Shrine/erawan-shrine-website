...
const text = {
  th: {
    ...
    paragraphs: [
      ...
      "ศาลแห่งนี้สร้างขึ้นในปี พ.ศ. 2499 ในช่วงการก่อสร้างโรงแรมเอราวัณในขณะนั้น โดยระหว่างการก่อสร้างได้เกิดอุปสรรคและเหตุขัดข้องหลายประการ จึงมีการปรึกษาผู้เชี่ยวชาญด้านโหราศาสตร์และคติความเชื่อไทย ซึ่งได้แนะนำให้สร้างศาลเทพารักษ์ขึ้นเพื่อความเป็นสิริมงคลแก่สถานที่ และเป็นที่ยึดเหนี่ยวทางจิตใจของผู้คน",
