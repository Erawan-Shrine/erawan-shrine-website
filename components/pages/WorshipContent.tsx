...
const text = {
  ...
  zh: {
    title: "四面佛參拜方式",
    subtitle:
      "伊拉旺神壇免費開放參拜，每日開放時間為 06:00–22:00，實際開放與關閉時間可能依現場公告而有所調整。",
    stepsTitle: "參拜步驟",
    steps: [
      {
        title: "準備供品",
        desc: "信眾可自行準備香、蠟燭與花環等供品，或於神壇周邊攤位選購供品組合，價格依供品種類與規格而異。",
      },
      {
        title: "從正面的面容開始參拜",
        desc: "從正面的面容開始，敬上香3支、蠟燭1支、花環1個，並以恭敬的心默念祈願。點香、點燭請依當日神壇現場的公告與規定進行。",
      },
      {
        title: "順時針依序參拜四面",
        desc: "依順時針方向走到第二、第三、第四面，以相同方式敬奉供品，直到四面皆已參拜完畢。",
      },
      {
        title: "參拜完畢後合十拜別",
        desc: "四面皆參拜完畢後，默念感恩之意並合十拜別大梵天王，即完成整個參拜儀式。",
      },
    ],
    offeringsTitle: "供品與其意義",
    offerings: [
      { icon: "🕯️", name: "香12支", meaning: "用於參拜四面，每面敬上3支。" },
      { icon: "🔥", name: "蠟燭4支", meaning: "每面敬上1支，象徵光明、吉祥與人生的指引。" },
      { icon: "🪷", name: "花環4個", meaning: "每面敬上1個，表達敬意與虔誠信仰。" },
      { icon: "🐘", name: "木雕大象", meaning: "信眾常見的額外供品，象徵穩固、智慧、豐盛與吉祥。" },
      { icon: "🎶", name: "泰式傳統舞蹈還願", meaning: "當祈願實現時，用以表達敬意與感恩之心的還願方式。" },
    ],
    etiquetteTitle: "參拜注意事項",
    etiquette: [
      "請著端莊服裝，並注意神聖場所應有的合宜舉止",
      "請輕聲交談，並尊重正在參拜的其他信眾",
      "可穿著鞋子入內，因神壇位於戶外空間",
      "請保持環境整潔，並遵守現場工作人員的指示或公告",
    ],
  },
};
